...
class MessagePaddingTests: XCTestCase {
    ...
    func testBasicPadding() {
        ...
        le/Users/miggu69/Downloads/schat-main/bitchatTests/BitchatMessageTests.swift
        guard let decoded = BitchatMessage.fromBinaryPayload(encoded) else {t padded = MessagePadding.pad(originalData, toSize: targetSize)
