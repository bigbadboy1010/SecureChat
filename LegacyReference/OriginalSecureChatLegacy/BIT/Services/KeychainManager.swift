...
class KeychainManager {
    ...
    private let service = "com.bit.chat.securestore"
...
// MARK: - Ratchet Sessions (Signal-class)

func saveRatchetSession(_ data: Data, peerID: String) -> Bool {
    return saveData(data, forKey: "ratchet_\(peerID)")
}

func getRatchetSession(peerID: String) -> Data? {
    return retrieveData(forKey: "ratchet_\(peerID)")
}

func deleteRatchetSession(peerID: String) -> Bool {
    return delete(forKey: "ratchet_\(peerID)")
}
